...
const note=document.createElement('p');note.className='finance-note';note.textContent='Bokførte bevegelser på konto 3000–3999 (inntekter) og 4000–7999 (kostnader), i NOK. Finansposter, skatt og årsoppgjør er ikke med. Pågående måned er foreløpig. Fremtidige måneder vises uten tall.';
...
results.replaceChildren(summary,chartFrame,legend,details,note);
}
